...
OUT_X_PATH = "expanded_X_min2.npy"
OUT_Y_PATH = "expanded_y_min2.npy"
OUT_META_PATH = "expanded_meta_min2.json"
...
def main():
    ...
    print(f"OUT_X_PATH     : {OUT_X_PATH}")
    print(f"OUT_Y_PATH     : {OUT_Y_PATH}")
    ...
    print(f"[done] metadata written: {OUT_META_PATH}")

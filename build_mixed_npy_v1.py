...
# CONFIG
# -----------------------------------------------------------------------------
BASE_X_PATH = "expanded_X_min2.npy"
BASE_Y_PATH = "expanded_y_min2.npy"
LMDB_PATH = "fixed_qtable.lmdb"

OUT_X_PATH = "mixed_X_v1.npy"
OUT_Y_PATH = "mixed_y_v1.npy"
OUT_META_PATH = "mixed_meta_v1.json"
...
def main():
    ...
    base_x = np.load(BASE_X_PATH, mmap_mode="r")
    base_y = np.load(BASE_Y_PATH, mmap_mode="r")
    ...
    with open(OUT_META_PATH, "w", encoding="ascii") as f:
        json.dump(meta, f, indent=2)

    print(f"[done] wrote {OUT_X_PATH}")
    print(f"[done] wrote {OUT_Y_PATH}")
    print(f"[done] wrote {OUT_META_PATH}")
